...
export default function DashboardHome() {
    ...
    return (
      <div className="flex items-center justify-center min-h-[60vh]">
        <div className="relative w-16 h-16">
          ...
          <Droplet size={24} className="absolute inset-0 m-auto text-red-600 animate-pulse" />
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-8 max-w-7xl mx-auto px-1">
      ...
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-red-600 via-rose-600 to-red-700 p-8 text-white shadow-xl">
        ...
        <div className="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
          <div>
            ...
            <p className="text-red-100/90 mt-2 text-sm md:text-base font-light max-w-xl leading-relaxed">
              Your contribution saves lives. Check your eligibility, keep track of donation requests, and manage your schedule below.
            </p>
          </div>
          <Link 
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition duration-300 flex items-center justify-between group">
          <div className="space-y-1">
            <p className="text-xs font-semibold text-gray-500 uppercase tracking-wider">Your Blood Group</p>
            <p className="text-3xl font-extrabold text-gray-900">{bloodGroup}</p>
          </div>
        ...
        <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition duration-300 flex items-center justify-between group">
          <div className="space-y-1">
            <p className="text-xs font-semibold text-gray-500 uppercase tracking-wider">Total Donations</p>
        ...
        <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition duration-300 flex items-center justify-between group">
          <div className="space-y-1">
            <p className="text-xs font-semibold text-gray-500 uppercase tracking-wider">Eligibility Status</p>
        ...
        <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition duration-300 flex items-center justify-between group">
          <div className="space-y-1">
            <p className="text-xs font-semibold text-gray-500 uppercase tracking-wider">Estimated Impact</p>
            <p className="text-3xl font-extrabold text-gray-900">9 Lives Saved</p>
          </div>
              ...
              >
                <div className="space-y-2">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h3 className="font-bold text-gray-900 text-sm md:text-base">{request.patientName}</h3>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm space-y-6">
            <div className="flex items-center gap-4">
              ...
              />
              <div>
                <h3 className="font-bold text-gray-900">{user?.name || 'Blood Donor'}</h3>
            ...
            <div className="border-t pt-4 space-y-3 text-sm">
              ...
              <div className="flex justify-between">
                ...
                <span className="text-gray-800 font-semibold text-right max-w-[150px] truncate" title={location}>
                  {location}
                </span>
              </div>
            </div>
          ...
          <div className="bg-[#0f172a] text-white p-6 rounded-2xl shadow-xl space-y-4 relative overflow-hidden">
            ...
            <p className="text-xs text-slate-300 font-light leading-relaxed">
              Create a new blood request post. Our platform matches and alerts donors in your area instantly.
            </p>
